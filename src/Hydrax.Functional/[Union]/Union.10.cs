...
namespace Hydrax.Functional {
    public abstract class Union<TBase, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
        where T1 : TBase
        where T2 : TBase
        where T3 : TBase
        where T4 : TBase
        ...
        where T10 : TBase
    {
            ...
            Func<T10, TResult> t10Fn)
        {
            ...
            if(this is T10 t10) { return t10Fn(t10); }
            ...
            Action<T10> t10Ac)
        {
            ...
            if(this is T10 t10) { t10Ac(t10); return; }
